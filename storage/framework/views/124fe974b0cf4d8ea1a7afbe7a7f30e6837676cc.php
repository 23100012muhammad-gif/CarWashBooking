...
<?php $__env->startSection('title', 'Manajemen Slot & Jadwal'); ?>
                            ...
                            <div class="card mb-3">
                                <div class="card-body">
                                    <div class="d-flex justify-content-between align-items-center mb-3">
                                        <h6 class="card-title mb-0"><?php echo e($day); ?></h6>
                                        <div class="form-check form-switch">
                                            <input type="checkbox" class="form-check-input" 
                                                   name="days[<?php echo e($day); ?>][status_operasional]" 
                                                   id="status_<?php echo e($day); ?>" checked>
                                            <label class="form-check-label" for="status_<?php echo e($day); ?>">
                                                Aktif
                                            </label>
                                        </div>
                                    </div>
                                    <div class="row g-3">
                                        <div class="col-sm-6">
                                            ...
                                            <input type="time" class="form-control" 
                                                   name="days[<?php echo e($day); ?>][jam_buka]" required>
                                        </div>
                                        <div class="col-sm-6">
                                            <label class="form-label">Jam Tutup</label>
                                            <input type="time" class="form-control"
                                                   name="days[<?php echo e($day); ?>][jam_tutup]" required>
                                        </div>
                                    </div>
                                </div>
                            </div>
...
<script src="<?php echo e(asset('js/admin_slots.js')); ?>"></script>
<?php $__env->stopPush(); ?>
<?php echo $__env->make('layouts.admin_master', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\CarWashConnect\resources\views/admin/slots/index.blade.php ENDPATH**/ ?>
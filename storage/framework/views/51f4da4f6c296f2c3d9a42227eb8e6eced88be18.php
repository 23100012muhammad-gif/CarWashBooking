<?php $__env->startSection('title', 'Profil - Car Wash Booking'); ?>
        ...
        <div class="col-md-8">
            ...
            <div class="card shadow mb-4">
                <div class="card-body text-center py-5">
                    ...
                    <small class="text-muted">Member sejak <?php echo e(Auth::user()->created_at->format('M Y')); ?></small>
                </div>
            </div>
...
<?php echo $__env->make('layouts.carwash', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\CarWashConnect\resources\views/profile.blade.php ENDPATH**/ ?>
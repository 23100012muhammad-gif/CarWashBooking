...
<head>
    ...
    <title>Login - CarWash Connect</title>
            ...
            <div class="col-md-6 col-lg-5">
                <div class="login-card p-5">
                    <div class="text-center mb-4">
                        ...
                        <h2 class="mt-3 text-primary">CarWash Connect</h2>
                    ...
                    <form method="POST" action="<?php echo e(route('login')); ?>">
                        ...
                        <div class="text-center">
                            ...
                            <p class="mb-0">
                                Belum punya akun? <a href="<?php echo e(route('register')); ?>" class="text-decoration-none">Daftar di sini</a>
                            </p>
                            <hr>
...
<?php /**PATH C:\xampp\htdocs\CarWashConnect\resources\views/auth/login.blade.php ENDPATH**/ ?>
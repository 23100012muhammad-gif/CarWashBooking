...
<head>
    ...
    <title>@yield('title', 'Car Wash Booking')</title>
        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="navbarNav">
                <ul class="navbar-nav me-auto">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" href="{{ route('booking.status') }}">Status</a>
                    </li>
                    <li class="nav-item">
                ...
                <ul class="navbar-nav">
                    @auth
                        ...
                        @if(Auth::user()->is_admin || in_array(Auth::user()->email, ['admin@carwash.com', 'admin@example.com']))
                        <li class="nav-item">
